...
func (x *PlaceOrderReq) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.Currency, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *PlaceOrderReq) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 2, x.GetCurrency())
	return offset
}
...
func (x *Order) fastWriteField4(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 4, x.GetCurrency())
	return offset
}
...
func (x *PlaceOrderReq) sizeField2() (n int) {
	...
	n += fastpb.SizeString(2, x.GetCurrency())
	return n
}
...
func (x *Order) sizeField4() (n int) {
	...
	n += fastpb.SizeString(4, x.GetCurrency())
	return n
}
