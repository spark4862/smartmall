...
type RPCClient interface {
	...
	Service() string
	SendEmail(ctx context.Context, Req *email.EmailReq, callOptions ...callopt.Option) (r *email.EmailResp, err error)
}
...
func (c *clientImpl) SendEmail(ctx context.Context, Req *email.EmailReq, callOptions ...callopt.Option) (r *email.EmailResp, err error) {
